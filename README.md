# Foveated Recurrent Attention (ENN-RAM)

This implementation of the ENN-RAM is based on the RAM implementation of Kevin Zakka. 
Changes have been made to integrate an ENN architecture into the glimpse sensor of the RAM.

Following figure depicts the adapted glimpse network with the ENN sensor:
<p align="center">
 <img src="./plots/enn_ram_glimpsenetwork.png" alt="ennram", width=70%>
</p>

Repo of RAM implementation: [kevinzakka/recurrent-visual-attention](https://github.com/kevinzakka/recurrent-visual-attention)

More information on the RAM architecture in the original readme:
