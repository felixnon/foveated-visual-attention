"""
Parser for the stated parameters.
The networks parameters are specified here as well as their default values.
"""
...
glimpse_arg.add_argument('--patch_size', type=int, default=24,
                         help='size of extracted patch at highest res')
glimpse_arg.add_argument('--glimpse_scale', type=int, default=3,
...
glimpse_arg.add_argument('--loc_hidden', type=int, default=1024,
...
core_arg.add_argument('--hidden_size', type=int, default=2048,
...
data_arg.add_argument('--val_file', type=str, default=None,
...
misc_arg.add_argument('--ckpt_file', type=str, default=None,
                      help='Name of specific checkpoint that should be loaded.')
